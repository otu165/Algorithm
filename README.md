...
|출처| 문제 번호 | 제목 | 해결 | 알고리즘|
|---| :-------- | :---------------- | :----: | :---:|
|백준 | 1013 | Contact | 🔺 | 정규표현식 |
|백준 | 2225 | 합분해 | 🔺 | DP |
|백준 | 2583 | 영역 구하기 | ✔️ | DFS |
|백준 | 2636 | 치즈 | ✔️ | BFS |
...
|---| :-------- | :---------------- | :----: | :---:|
|백준 | 1707 | 이분 그래프 | 🔺 | DFS |
|백준 | 2841 | 외계인의 기타 연주 | 🔺 | 스택 |
|백준 | 7490 | 0 만들기 | ✔️ | 브루트포스 |
...
|출처| 문제 번호 | 제목 | 해결 | 알고리즘|
|---| :-------- | :---------------- | :----: | :---:|
|백준 | 1254 | 팰린드롬 만들기 | 🔺 | 브루트포스 |
|백준 | 1927 | 최소 힙 | ✔️ | 최소 힙 |
|백준 | 14891 | 톱니바퀴 | ✔️ | 구현, 시뮬레이션 |
...
|백준| 5710 | 전기 요금  | ✔️ | 이분탐색 |
|백준| 16954 | 움직이는 미로 탈출  | ✔️ | BFS |
